...
<form  name="fregister" id="fregister" action="https://buts.co.kr/bbs/register_form.php" onsubmit="return fregister_submit(this);" method="POST" autocomplete="off" class="form" role="form">
    ...
    <div class="h3"><span class="text-purple">약관</span> 동의</div>
    <div class="form-round scroll">
        ...
        <div class="page-content">
            ...
            <p>이 약관은 툴82 회사(전자상거래 사업자로 이하 "회사"라 한다)가 운영하는 툴82 쇼핑몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.</p>
    ...
    <div class="button-align center">
        ...
        <a href="regForm"><button type="button" class="button button-purple">회원가입</button></a>
    </div>
</form>
</div>